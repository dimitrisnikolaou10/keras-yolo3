...
def _main():
    annotation_path = '../resized_images/custom_annotations_only_humans.txt'
    log_dir = 'logs/000/'
    ...
    early_stopping = EarlyStopping(monitor='val_loss', min_delta=0, patience=1000, verbose=1) # purposefully overfitting
    ...
    if True:
        model.compile(optimizer=Adam(lr=1e-1), loss={
